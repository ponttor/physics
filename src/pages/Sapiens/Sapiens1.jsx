...
import all from '../../images/sapiens/all.png'

export default class Sapiens1 extends React.Component {
  render() {
    return (
      <>
            ...
            <main className="col">
              <div className="card" >
                <div className="card-body">
                  <h3 className="card-title">Ничем не выделяющееся животное</h3>
...
Ход человеческой истории определили три крупнейшие революции: <span style={{ fontWeight: 'bold' }}>Когнитивная</span> (70 тысяч лет назад), <span style={{ fontWeight: 'bold' }}>Аграрная</span> (12 тысяч лет назад), <span style={{ fontWeight: 'bold' }}>Научная</span> (500 лет назад).</p>
                  ...
                  <div className="d-flex justify-content-center flex-column">
                      <img src={all} className="m-2" style={{ width: "40rem" }}></img>
                      {/* <p className="card-text">Наши ближайшие живые родственники</p> */}
                  </div>
                  </div>
